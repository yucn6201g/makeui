import type { RuntimeFacts } from '../tools/browser-verify.js';
import { passingPair, toHexColour } from './runtime-audit.js';
import { isDecorativeShadow, outsideFoundation, withoutFoundation } from './preset-conformance.js';
import { stylesheetOf, spliceStylesheet, readProjectFiles, writeProjectFile } from '../tools/project-transport.js';
