...
import { reactFiles, declaredScreenIds, type InteractionDefect } from '../audit/interaction-audit.js';
import { unreachableControls } from '../../tools/fixups/keyboard-reach.js';
 ...
 * click can be reached without a mouse. `tools/fixups/keyboard-reach.ts` decides that,
