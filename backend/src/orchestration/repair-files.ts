...
import { reactFiles } from './interaction-audit.js'
import { leafModule } from './leaf-modules.js'
import { unresolvedImports, addMissingBarrels, isProvidedModule } from '../tools/react-bundle.js'
import { detectKind, compileFile } from '../tools/framework-compile.js'
...
import { isFencedTransport, writeProjectFile } from '../tools/project-transport.js'
