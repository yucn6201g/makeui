import { foundationPromptBlock, presetFoundation, withFoundationCss, withoutTokenDeclarations } from './preset-foundation.js';
import { shellRequirement } from './preset-composition.js';
import { FRAMEWORKS, type OutputKind } from '../config/frameworks.js'
import type { SystemPrompt } from './prompt-cache.js';
import { writeProjectFile } from '../tools/project-transport.js'
import { parses, cleanFile, foreignImport } from './repair-files.js'
import { signatureOf } from './signature.js'
import { toRunnableDocument, unresolvedImports, addMissingBarrels } from '../tools/react-bundle.js'
import { fixupFile } from '../tools/framework-fixups.js'
...
/** Re-exported so the caller can splice a repaired file back the usual way. */
export { writeProjectFile }
