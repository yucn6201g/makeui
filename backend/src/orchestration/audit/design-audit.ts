...
import { UTILITY_CLASS, definedClasses, UTILITY_BLOCK_MARKER } from '../../tools/fixups/utility-css.js';
...
/*
 * The detector lives in `tools/fixups/utility-css.ts` now, beside the generator that
