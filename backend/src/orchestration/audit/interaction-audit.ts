...
import { formControlRules, smallControlFonts, textEntryControlTags } from '../../tools/fixups/form-controls.js';
import { renderedFrom } from '../../tools/fixups/artwork.js';
import { unguardedCheckouts } from '../../tools/fixups/shell-fixes.js';
import { unhandledDispatches } from '../../tools/fixups/source-consistency.js';
 ...
 * renders — now lives in tools/fixups/artwork.ts, with the fixup that draws what a
 ...
 * small, now live in tools/fixups/form-controls.ts — unchanged, and shared with the
 ...
 * the old reader cut the file there — see tools/project/project-transport.ts.
 */
...
export function auditShellContract(html: string, outputKind: OutputKind): InteractionDefect[] {
  ...
  // A checkout that renders its form over an empty cart — see tools/fixups/shell-fixes.ts.
  ...
  /*
   * An action no reducer handles — see tools/fixups/source-consistency.ts. The names
