...
import { pictureFrames } from '../tools/picture-frames.js'
import { PHOTO_SLOT } from '../tools/stock-images.js'
import { auditInteractivity, auditShellContract, declaredScreenIds, type InteractionDefect } from './interaction-audit.js'
...
export interface ChangeDiagnosis {
 ...
 */
export function locateTargetElement(files: Map<string, string>, selector: string, ext: string): string[] {
