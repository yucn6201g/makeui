import { FILE_CLOSE, FILE_OPEN, readProjectFiles } from './project-transport.js'
 ...
 */
export const SUPPLIED_FILE = /^(?:package(?:-lock)?\.json|tsconfig(?:\.[\w-]+)?\.json|vite\.config\.[cm]?[jt]s|index\.html)$/
