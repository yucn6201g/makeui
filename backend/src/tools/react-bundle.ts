...
import { reactFiles } from '../orchestration/interaction-audit.js'
 ...
 *
 * This deliberately mirrors frontend/src/utils/reactPreview.ts. The two exist
...
export interface RunnableDocument {
 ...
 * `frontend/src/utils/previewGuard.ts` installs the same in-memory stand-in in
