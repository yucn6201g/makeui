...
execSync(
  `npx esbuild "${path.join(root, 'src/orchestration/prompts/prompt-contracts.ts')}" --bundle --platform=node --format=esm ` +
...
const contracts = { react: projectContract('react'), vue: projectContract('vue') };
